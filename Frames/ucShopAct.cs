...
namespace Tax_Consultant_25.Frames
{
    public partial class ucShopAct : UserControl
    {
        ...
        private void dgvShopAct_DataBindingComplete(object sender, DataGridViewBindingCompleteEventArgs e)
        {
            if (ROLE == "User")
            {
            ...
            dgvShopAct.Columns["btnReply"].DisplayIndex = dgvShopAct.Columns.Count - 1;
        }
        ...
        private void dgvShopAct_CellFormatting(object sender, DataGridViewCellFormattingEventArgs e)
        {
            ...
            if (dgvShopAct.Columns[e.ColumnIndex].Name == "btnReply")
            {
                string text = dgvShopAct.Rows[e.RowIndex].Cells["btnReply"].Value?.ToString();
        ...
        private void dgvShopAct_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                ...
                if (dgvShopAct.Rows.Count >= 0)
                {
                    ...
                    tempEmployeeName = dgvShopAct.Rows[objPro.rowID].Cells[6].Value.ToString().Trim();
                    CLIENTNAME = dgvShopAct.Rows[objPro.rowID].Cells[3].Value.ToString();
                ...
                if (e.ColumnIndex == dgvShopAct.Columns["btnReply"].Index)
                {
                    ...
                    query.workId = tempShopActId;
                    query.role = ROLE;
                    query.employeeName = tempEmployeeName;
                    query.serviceName = "SHOPACT";
        ...
        private void show()
        {
            ...
            ds = shopActDL.showData(ROLE, EMPLOYEENAME);
            ...
            else
            {
                ...
                if (ROLE == "User")
                {
                    dgvShopAct.Columns["EMPLOYEENAME"].Visible = false;
                }
        ...
        private void ShowQuery()
        {
            ...
            ds1 = query.QueryRaisedByEmp("SHOPACT");
            ...
            foreach (DataGridViewRow row in dgvShopAct.Rows)
            {
                ...
                row.DefaultCellStyle.BackColor = hasQuery ? Color.LightCoral : dgvShopAct.DefaultCellStyle.BackColor;
        ...
        private void ShowReply()
        {
            ...
            ds2 = query.showReplyByAdmin("SHOPACT");
            ...
            foreach (DataGridViewRow row in dgvShopAct.Rows)
            {
                ...
                row.DefaultCellStyle.BackColor = hasReply ? Color.LightGreen : dgvShopAct.DefaultCellStyle.BackColor;
